...
const App: React.FC = () => {
  return (
    ...
    <div className="h-screen w-full bg-black md:bg-neutral-900 flex items-center justify-center overflow-hidden">
      ...
      {/* 
         手机模拟器容器逻辑:
         1. Mobile (默认): fixed inset-0, z-50, w-full, h-full.
            KEY FIX: Use 'fixed inset-0' instead of 'absolute h-[100dvh]' to ensure robust full-screen coverage on mobile 
            without gaps caused by dynamic address bars or safe area calculations.
      ...
      */}
      <div 
        ...
        `}
        // Create a new stacking context for desktop containment
